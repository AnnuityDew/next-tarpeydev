...
export function TimelineChart(chartData) {
  ...
  var plotData = [
    {
      x: xDataClean,
      y: chartData["y_data_c"],
      name: "Completed",
      hovertext: chartData["y_data_c"],
      stackgroup: "one",
      groupnorm: "percent",
    },
    {
      x: xDataClean,
      y: chartData["y_data_b"],
      name: "Beaten",
      hovertext: chartData["y_data_b"],
      stackgroup: "one",
    },
    {
      x: xDataClean,
      y: chartData["y_data_s"],
      name: "Started",
      hovertext: chartData["y_data_s"],
      stackgroup: "one",
    },
    {
      x: xDataClean,
      y: chartData["y_data_ns"],
      name: "Not Started",
      hovertext: chartData["y_data_ns"],
      stackgroup: "one",
    },
  ]
  var layout = {
